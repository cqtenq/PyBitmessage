...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        aboutDialog.resize(376, 342)
        self.buttonBox = QtGui.QDialogButtonBox(aboutDialog)
        self.buttonBox.setGeometry(QtCore.QRect(20, 300, 311, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.label = QtGui.QLabel(aboutDialog)
        self.label.setGeometry(QtCore.QRect(70, 161, 111, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.labelVersion.setGeometry(QtCore.QRect(190, 161, 161, 20))
        self.labelVersion.setObjectName(_fromUtf8("labelVersion"))
        self.label_2 = QtGui.QLabel(aboutDialog)
        self.label_2.setGeometry(QtCore.QRect(10, 186, 341, 41))
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(aboutDialog)
        self.label_3.setGeometry(QtCore.QRect(20, 236, 331, 71))
        self.label_3.setWordWrap(True)
        self.label_3.setOpenExternalLinks(True)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_5 = QtGui.QLabel(aboutDialog)
        self.label_5.setGeometry(QtCore.QRect(10, 233, 341, 20))
        self.label_5.setAlignment(QtCore.Qt.AlignCenter)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.label_4 = QtGui.QLabel(aboutDialog)
        self.label_4.setGeometry(QtCore.QRect(96, 8, 151, 151))
        self.label_4.setText(_fromUtf8(""))
        self.label_4.setPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/feathercoin.png")))
